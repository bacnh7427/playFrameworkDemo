...
package controllers.javascript {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    def welcome: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(name0,last_name1) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "welcome/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("name", name0)) + "/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("last_name", last_name1))})
        }
      """
    )
